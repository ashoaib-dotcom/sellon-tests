...
test('GTIN: should accept valid GTIN-8 (40170725)', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-gtin8-valid.png', fullPage: true }); } catch {}
...
test('GTIN: should reject invalid GTIN-8 (40170724)', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-gtin8-invalid.png', fullPage: true }); } catch {}
...
test('GTIN: should accept valid GTIN-12 (614141007349)', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-gtin12-valid.png', fullPage: true }); } catch {}
...
test('GTIN: should reject invalid GTIN-12 (614141007341)', async () => {
  ...
  await productForm.clickSave();
  await productForm.expectHasError();
  try { await page.screenshot({ path: 'screenshots/pom-val-gtin12-invalid.png', fullPage: true }); } catch {}
...
test('GTIN: should accept valid GTIN-13 (4006381333931)', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-gtin13-valid.png', fullPage: true }); } catch {}
...
test('GTIN: should reject invalid GTIN-13 (4006381333932)', async () => {
  ...
  await productForm.clickSave();
  await productForm.expectHasError();
  try { await page.screenshot({ path: 'screenshots/pom-val-gtin13-invalid.png', fullPage: true }); } catch {}
...
test('GTIN: should accept valid GTIN-14 (10400163001017)', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-gtin14-valid.png', fullPage: true }); } catch {}
...
test('GTIN: should reject invalid GTIN-14 (10400163001013)', async () => {
  ...
  await productForm.clickSave();
  await productForm.expectHasError();
  try { await page.screenshot({ path: 'screenshots/pom-val-gtin14-invalid.png', fullPage: true }); } catch {}
...
test('Provider key: should reject more than 50 characters', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-provider-long.png', fullPage: true }); } catch {}
...
test('Provider key: should accept valid characters (A-Z, 0-9, . , ! ? - _ @)', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-provider-valid-chars.png', fullPage: true }); } catch {}
...
test('Price: should reject negative price', async () => {
  ...
  await productForm.clickSave();
  await productForm.expectHasError();
  try { await page.screenshot({ path: 'screenshots/pom-val-price-negative.png', fullPage: true }); } catch {}
...
test('Price: should accept maximum valid price', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-price-max.png', fullPage: true }); } catch {}
  await productForm.fillField('Selling price', '49.9000');
...
test('VAT: should accept 2.60', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-vat-2.60.png', fullPage: true }); } catch {}
...
test('VAT: should accept 8.10', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-vat-8.10.png', fullPage: true }); } catch {}
...
test('Stock: should reject negative stock', async () => {
  ...
  await productForm.clickSave();
  await productForm.expectHasError();
  try { await page.screenshot({ path: 'screenshots/pom-val-stock-negative.png', fullPage: true }); } catch {}
...
test('Stock: should accept zero stock', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-stock-zero.png', fullPage: true }); } catch {}
  await productForm.fillField('Stock quantity', '100');
...
test('Supplementary data: should open tab', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-supplementary-tab.png', fullPage: true }); } catch {}
...
test('Media: should open tab', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-media-tab.png', fullPage: true }); } catch {}
...
test('Galaxus: should open tab', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-galaxus-tab.png', fullPage: true }); } catch {}
...
test('GTIN: empty GTIN should result in invalid product', async () => {
  ...
  await productForm.clickSave();
  await productForm.expectHasError();
  try { await page.screenshot({ path: 'screenshots/pom-val-gtin-empty.png', fullPage: true }); } catch {}
  // Restore valid GTIN
  await productForm.fillField('GTIN', '4006381333931');
...
test('Brand: should accept up to 100 characters', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-brand-100chars.png', fullPage: true }); } catch {}
...
test('Title DE: should not exceed 100 characters', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-title-too-long.png', fullPage: true }); } catch {}
...
test('Title DE: should not contain the brand name', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-title-contains-brand.png', fullPage: true }); } catch {}
  // Restore
  await productForm.fillField('Brand', 'TestBrand');
  await productForm.fillTitle('Valid German Title Test');
...
test('Description: should accept up to 4000 characters', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-desc-4000chars.png', fullPage: true }); } catch {}
...
test('Description: should reject HTML tags', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-desc-html.png', fullPage: true }); } catch {}
  await productForm.fillDescription('Short test description.');
...
test('Weight: should accept valid value within 0–100,000,000', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-weight-valid.png', fullPage: true }); } catch {}
...
test('Weight: should accept zero (optional field)', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-weight-zero.png', fullPage: true }); } catch {}
...
test('Restock time: range 0–365 should be accepted', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-restock-time.png', fullPage: true }); } catch {}
...
test('Restock time + Restock date: setting both should disable/error the other', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-restock-mutual.png', fullPage: true }); } catch {}
  // Clear restock time
...
test('Expected restock quantity: range 0–99,999 accepted', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-restock-qty.png', fullPage: true }); } catch {}
...
test('Media URL: at least one image required for stage 2', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-media-url-required.png', fullPage: true }); } catch {}
...
test('Stage: product with all warnings resolved should be stage 2 ready', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/pom-val-stage2-ready.png', fullPage: true }); } catch {}
...
test('Final: save product with all valid data', async () => {
  ...
  await productForm.clickSave();
  try { await page.screenshot({ path: 'screenshots/pom-val-final-save.png', fullPage: true }); } catch {}
...
test('Validation negative: VAT value of 0 should be rejected', async () => {
  ...
  await productForm.clickSave();
  await productForm.expectHasError();
  try { await page.screenshot({ path: 'screenshots/pom-val-neg-vat-zero.png', fullPage: true }); } catch {}
...
test('Validation negative: price of 0 should be rejected', async () => {
  ...
  await productForm.clickSave();
  await productForm.expectHasError();
  try { await page.screenshot({ path: 'screenshots/pom-val-neg-price-zero.png', fullPage: true }); } catch {}
...
test('Validation negative: stock quantity above max (100000) should be rejected', async () => {
  ...
  await productForm.clickSave();
  await productForm.expectHasError();
  try { await page.screenshot({ path: 'screenshots/pom-val-neg-stock-max.png', fullPage: true }); } catch {}
