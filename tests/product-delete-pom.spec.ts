...
test('Single Delete 1: Delete a Stage 1 product', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/del-1-stage1.png', fullPage: true, timeout: 5000 }); } catch {}
...
test('Single Delete 2: Delete a Stage 2 product', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/del-2-stage2.png', fullPage: true, timeout: 5000 }); } catch {}
...
test('Single Delete 3: Delete a product with Error status', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/del-3-error.png', fullPage: true, timeout: 5000 }); } catch {}
...
test('Single Delete 4: Cancel deletion — product should remain', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/del-4-cancel.png', fullPage: true, timeout: 5000 }); } catch {}
...
test('Bulk Delete 1: Select all products and delete', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/del-5-select-all.png', fullPage: true, timeout: 5000 }); } catch {}
...
test('Bulk Delete 2: Select 3 specific products and delete', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/del-6-bulk3.png', fullPage: true, timeout: 5000 }); } catch {}
...
test('Bulk Delete 3: Select multiple products and cancel — products remain', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/del-7-bulk-cancel.png', fullPage: true, timeout: 5000 }); } catch {}
...
test('Edge Case 2: Product count decreases by correct amount after delete', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/del-edge2-count.png', fullPage: true, timeout: 5000 }); } catch {}
...
test('Edge Case 3: Deleted product does not appear in the list', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/del-edge3-not-in-list.png', fullPage: true, timeout: 5000 }); } catch {}
...
test('Final: Verify product list after all deletions', async () => {
  ...
  try { await page.screenshot({ path: 'screenshots/del-final-list.png', fullPage: true, timeout: 5000 }); } catch {}
